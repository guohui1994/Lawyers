...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundColor = [HZPhotoBrowserBackgrounColor colorWithAlphaComponent:1.0];
...
- (void)layoutSubviews
{
    ...
    _indexLabel.bounds = CGRectMake(0, 0, Height_NavBar + 10, 30);
    _indexLabel.center = CGPointMake(self.bounds.size.width * 0.5, Height_NavBar - 15);
    _saveButton.frame = CGRectMake(screenWidth - 135, self.bounds.size.height - 70, 105, 30);
}
